...
from my.algo.fedsimsiam import FedSimsiamClient, FedSimsiamServer
from my.data import AugPairRotDataset
...
def main(
    *,
    ...
    server = FedSimsiamServer(
        ...
        device=device,
        checkpoint_path=f'./results/fedsimsiam_nash.pth'
    )
